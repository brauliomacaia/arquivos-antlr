// $ANTLR 2.7.6 (2005-12-22): "expr2.g" -> "ExprLexer.java"$
...
tryAgain:
	...
	public final void mSUFIXO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = SUFIXO;
		int _saveIndex;
	...
	public final void mFIM(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = FIM;
		int _saveIndex;
